...
//------------------------------------------------------------------------------
	...
	echo "<h1>Hosts</h1>";
	echo "<p>· <a href=\"accountform.php\" accesskey=\"a\"><b>A</b>dd</a> ·</p>";
	...
	function show ($data)
	{
		echo
		"<tr id=\"".$data["_id"]."\">"
		."<td><a href=\"accountform.php?id=".$data["_id"]."\"><img src=\"img/edit.png\" alt=\"\" /></a></td>"
		."<td class=\"edit\">".htmlspecialchars($data["username"])."</td>"
		."</tr>";
	}
