...
page_begin();
echo "<h1>Account</h1>";
echo "<p>· <a href=\"accountview.php\" accesskey=\"b\"><b>B</b>ack</a> · <a href=\"accountform.php\" accesskey=\"a\"><b>A</b>dd</a> ·</p>";

$collection = "account";

$fields = array(
  array("text", "Username", "username", ""),
  array("text", "Password", "password", "")
);
